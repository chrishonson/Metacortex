...
- if switching from any previous embedding model to `text-multimodal-embedding-002`, confirm the target Firestore collection is clean, re-embedded, or replaced before mixing traffic
